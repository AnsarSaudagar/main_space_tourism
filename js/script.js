...
// for destination content change
...
// console.log(fullObj.destinations[0].name);
...
const destinationDays = document.querySelector("#days")
...
const changeContentDestination = (index) => {
    destinationImg.src = fullObj.destinations[index].images.png

    destinationHeading.textContent = fullObj.destinations[index].name.toLocaleUpperCase()

    destinationPara.textContent = fullObj.destinations[index].description

    destinationDistance.textContent = fullObj.destinations[index].distance.toUpperCase()

    destinationDays.textContent = fullObj.destinations[index].travel.toUpperCase()
}
...
moonBtn.addEventListener("click", () => {
    //Changing images
    changeContentDestination(0);
})
marsBtn.addEventListener("click", () => {
    //Changing images
    changeContentDestination(1);
})
europaBtn.addEventListener("click", () => {
    //Changing images
    changeContentDestination(2);
})
titanBtn.addEventListener("click", () => {
    //Changing images
    changeContentDestination(3);
})
